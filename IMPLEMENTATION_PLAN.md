...
### Задача 32: Настройка асинхронной обработки с Kafka
- Интегрировать Kafka для внутреннего логирования и фоновой обработки
- Реализовать отправку событий о действиях пользователей в Kafka
- Настроить асинхронную обработку тяжелых операций
